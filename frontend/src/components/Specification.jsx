...
const Specification = () => {
  return (
    <div className='specifications'>
        ...
        <div className="boxes">
        <div>
        <i class="fa-light fa-truck-fast" style={{"color": "#1abc9c"}}></i>
        <span>
        <h3>Free Shipping</h3>
        ...
        <div>
        <i class="fa-solid fa-person-walking-arrow-loop-left" style={{"color": "#f1c40f"}}></i>
        <span>
        <h3>Easy Return</h3>
        ...
        <div>
        <i class="fa-solid fa-headphones-simple" style={{"color": "#81ecec"}}></i>
        <span>
          <h3>24/7 Support</h3>
